...
export const getContextualWeatherAdvice = (symbolCode: string, context: WeatherContext): string => {
  ...
  if (effectiveTemp && effectiveTemp > 20) {
    if (isWeekend && (symbolCode.includes('clear') || symbolCode.includes('fair'))) {
  ...
  if (effectiveTemp && effectiveTemp > 15) {
    return symbolCode.includes('clear') || symbolCode.includes('fair')
  ...
  if (isWeekend && !symbolCode.includes('rain') && effectiveTemp && effectiveTemp > 10) {
